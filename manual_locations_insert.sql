...
-- GROUND FLOOR (RDC)
INSERT INTO public.locations (id, name, type, floor, building, capacity, amenities, is_active) VALUES
(gen_random_uuid(), 'Terrasse', 'ground_floor', 0, 'Main Tower', 30, '["outdoor"]', true),
(gen_random_uuid(), 'Accueil', 'ground_floor', 0, 'Main Tower', 50, '["reception"]', true),
(gen_random_uuid(), 'Ascenseur', 'ground_floor', 0, 'Main Tower', 8, '["elevator"]', true),
(gen_random_uuid(), 'Salon', 'ground_floor', 0, 'Main Tower', 60, '["lounge"]', true),
(gen_random_uuid(), 'Salle petit-déjeuner bar', 'ground_floor', 0, 'Main Tower', 80, '["dining"]', true),
(gen_random_uuid(), 'Bagagerie bureau', 'ground_floor', 0, 'Main Tower', 20, '["luggage"]', true),
(gen_random_uuid(), 'Cours', 'ground_floor', 0, 'Main Tower', 40, '["courtyard"]', true);
