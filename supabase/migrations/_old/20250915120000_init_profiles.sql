...
CREATE TABLE IF NOT EXISTS "archive"."activity_log" (
    "id" "uuid",
    "user_id" "uuid",
    "task_id" "uuid",
    "task_type" "text",
...
ALTER TABLE "archive"."activity_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "archive"."comments" (
    "id" "uuid",
    "user_id" "uuid",
    "task_id" "uuid",
    "task_type" "text",
...
ALTER TABLE "archive"."comments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "archive"."profiles" (
    "id" "uuid",
    "first_name" "text",
    "last_name" "text",
    "email" "text",
...
ALTER TABLE "archive"."profiles" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "archive"."reminders" (
    "id" "uuid",
    "task_id" "uuid",
    "task_type" "text",
    "title" "text",
    ...
    "frequency" "public"."reminder_frequency",
    "is_active" boolean,
    "created_by" "uuid",
    "created_at" timestamp with time zone,
    "updated_at" timestamp with time zone,
...
ALTER TABLE "archive"."reminders" OWNER TO "postgres";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."client_requests";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."escalations";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."follow_ups";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."internal_tasks";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."staff_directory";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."task_members";
